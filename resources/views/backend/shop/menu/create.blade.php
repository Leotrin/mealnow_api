        ...
        <div class="span12">
            <div class="grid simple ">
                <div class="grid-title">
                    <h4>{{ $shop->name }} - Menu <span class="semi-bold">manangement</span></h4>
                    <div class="tools">
                        <a href="javascript:;" class="collapse"></a>
                    </div>
                </div>
                <div class="grid-body">
                    <div class="col-md-12" style="padding:10px;background: #f3f3f3;">
...
{{--                                        <input type="hidden" value="" id="category_id">--}}
                            ...
                            <div class="clearfix"></div>
                            <div class="col-md-12 p10" style="border:1px solid #ccc;background:#fafafa;" id="menuItems">
                            </div>
