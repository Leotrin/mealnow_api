        ...
        <div class="row">
            <div class="col-md-4 col-12 col-sm-12">
                ...
                <div class="app">
                    ...
                    <a href="#">
                        <img class="img-fluid" src="/new_front/img/google.png">
                    </a>
                    <a href="#">
                        <img class="img-fluid" src="/new_front/img/apple.png">
                    </a>
                </div>
            </div>
...
<footer class="pt-4 pb-4 text-center">
    <div class="container">
        ...
        <small class="mt-0 mb-0"> Made with <i class="fas fa-heart heart-icon text-danger"></i> by
            <a class="text-danger" target="_blank" href="http://www.mangosoft.com.mk">Mangosoft</a> - <a class="text-primary" target="_blank" href="http://www.mangosoft.com.mk/">Ask Berat</a>
        </small>
    </div>
</footer>